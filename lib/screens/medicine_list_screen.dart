...
class MedicineListScreen extends StatefulWidget {
  final String categoryId; // Nhận id danh mục
  final String categoryName; // Nhận tên danh mục (hoặc mô tả của danh mục)

  MedicineListScreen({required this.categoryId, required this.categoryName}); // Constructor nhận id và tên danh mục
...
class _MedicineListScreenState extends State<MedicineListScreen> {
  ...
  void fetchMedicines() async {
    ...
    try {
      ...
      List<Medicine> medicineList = await apiMedicineServices.fetchMedicinesByCategory(widget.categoryId);
    ...
    return Scaffold(
      appBar: AppBar(
        title: isLoading
            ...
            : Text(widget.categoryName), // Hiển thị tên hoặc mô tả của danh mục
